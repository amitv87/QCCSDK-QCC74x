 ...
 *
 */
struct qcc74x_emac_handle_s {
    struct qcc74x_emac_bd_desc_s *bd;
...
static struct qcc74x_emac_handle_s eth_handle;
static struct qcc74x_emac_handle_s *thiz = NULL;
...
{
    struct qcc74x_emac_bd_desc_s *DMADesc;
...
#if defined(QCC743)
        qcc74x_l1c_dcache_invalidate_range((void *)DMADesc->Buffer, len);
#endif
#endif
...
/**
 * @brief qcc74x emac deinit
 *
 * @param dev
 *
 */
void qcc74x_emac_deinit(struct qcc74x_device_s *dev)
{
    uint32_t reg_base;
    uint32_t reg_val;
...
/**
 * @brief qcc74x emac interrupt enable
 *
 * @param dev
 * @param flag
 * @param enable
...
/**
 * @brief qcc74x emac interrupt clear
 *
 * @param dev
 * @param flag
 *
...
/**
 * @brief qcc74x emac get interrupt status
 *
 * @param dev
 * @return uint32_t
 */
 ...
 *
 */
static void emac_dma_desc_list_init(uint32_t reg_base, struct qcc74x_emac_handle_s *handle, uint8_t *tx_buff, uint32_t tx_buff_cnt, uint8_t *rx_buff, uint32_t rx_buff_cnt)
{
    uint32_t i = 0;

    /* Set the Ethernet handler env */
    handle->bd = (struct qcc74x_emac_bd_desc_s *)(uintptr_t)(reg_base + EMAC_DMA_DESC_OFFSET);
...
/**
 * @brief qcc74x emac phy register read
 *
 * @param dev
 * @param phy_reg
 * @param phy_reg_val
...
/**
 * @brief qcc74x emac phy register write
 *
 * @param dev
 * @param phy_reg
 * @param phy_reg_val
...
/**
 * @brief qcc74x emac feature control
 *
 * @param dev
 * @param cmd
 * @param arg
