...
static __ALIGNED(4) qcc74x_flash_secreg_param_t g_param = { .raw = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff } };
...
static bool ATTR_TCM_SECTION qcc74x_flash_secreg_callapi_before(const spi_flash_cfg_type *flash_cfg, struct callapi_content *content)
{
    int ret;
...
static void ATTR_TCM_SECTION qcc74x_flash_secreg_callapi_after(const spi_flash_cfg_type *flash_cfg, struct callapi_content *content)
{
    const uint8_t group = 0;
    const uint8_t bank = 0;
...
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_oplock(void)
{
...
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_opunlock(void)
{
...
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_get_param(const qcc74x_flash_secreg_param_t **param)
{
    ...
    if (*((uint64_t *)&g_param) == 0xffffffffffffffff) {
        ...
        qcc74x_flash_get_cfg((void *)&pg_flash_cfg, &dummy);
    }
...
* @retval int               0:Success, -1:Not found secreg param
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_region_foreach(region_cb cb, void *data)
{
    int ret;
    const qcc74x_flash_secreg_param_t *param;
    qcc74x_flash_secreg_region_info_t info;

    if (qcc74x_flash_secreg_get_param(&param)) {
        return -1;
    }

    for (uint32_t i = 0; i < param->region_count; i++) {
        if ((ret = qcc74x_flash_secreg_get_info_by_idx(i, &info)) != 0) {
            return ret;
        }
...
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_get_lockbits(uint8_t *lockbits)
{
    const qcc74x_flash_secreg_param_t *param;
    ...
    if (qcc74x_flash_secreg_callapi_before(pg_flash_cfg, &content)) {
        /*!< get lock bit */
        ret = flash_secreg_apis[param->api_type].get_lock(
            pg_flash_cfg, param->lb_share ? 1 : param->region_count, param->lb_offset, &lb);
    }

    qcc74x_flash_secreg_callapi_after(pg_flash_cfg, &content);
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_set_lockbits(uint8_t lockbits)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t lb_mask;
...
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_get_locked(uint8_t index)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t lb;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_set_locked(uint8_t index)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t lb;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_get_info_by_idx(uint8_t index, qcc74x_flash_secreg_region_info_t *info)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t lb;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_valid_by_idx(uint8_t index, uint32_t offset, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_read_by_idx(uint8_t index, uint32_t offset, void *data, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint32_t address;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_write_by_idx(uint8_t index, uint32_t offset, const void *data, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint32_t address;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_erase_by_idx(uint8_t index)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint32_t address;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_get_info(uint32_t addr, qcc74x_flash_secreg_region_info_t *info)
{
    const qcc74x_flash_secreg_param_t *param;
    uint8_t index;
    ...
    return qcc74x_flash_secreg_get_info_by_idx(index, info);
}
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_valid(uint32_t addr, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    uint32_t valid_len;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_read(uint32_t addr, void *data, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t index;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_write(uint32_t addr, const void *data, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t index;
...
* @retval int               0:Success
*****************************************************************************/
int ATTR_TCM_SECTION qcc74x_flash_secreg_erase(uint32_t addr, uint32_t len)
{
    const qcc74x_flash_secreg_param_t *param;
    struct callapi_content content;
    uint8_t index;
