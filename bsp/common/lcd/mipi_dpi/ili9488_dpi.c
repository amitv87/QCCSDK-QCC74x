...
#include "qcc74x_undef_dbi.h"
#elif defined(QCC743)
#include "qcc743_dbi.h"
#endif
...
static struct qcc74x_device_s *ili9488_gpio;
static struct qcc74x_device_s *ili9488_spi;
...
static int ili9488_spi_write_cmd(uint8_t cmd)
{
    ILI9488_SPI_DC_LOW;
    ILI9488_SPI_CS_LOW;
    qcc74x_spi_poll_send(ili9488_spi, cmd);
    ILI9488_SPI_CS_HIGH;
    ILI9488_SPI_DC_HIGH;
    return 0;
}
...
{
    ILI9488_SPI_CS_LOW;
    qcc74x_spi_poll_send(ili9488_spi, data);
    ILI9488_SPI_CS_HIGH;
    return 0;
}
...
/* Ili9488 needs to be initialized using the DBI(typeC) or SPI interface */
    ...
    /* CS and DC pin init */
    ili9488_gpio = qcc74x_device_get_by_name("gpio");
    qcc74x_gpio_init(ili9488_gpio, ILI9488_DPI_SPI_CS_PIN, GPIO_OUTPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1);
    qcc74x_gpio_init(ili9488_gpio, ILI9488_DPI_SPI_DC_PIN, GPIO_OUTPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1);
    ILI9488_SPI_CS_HIGH;
    ILI9488_SPI_DC_HIGH;

    /* spi init */
    ili9488_spi = qcc74x_device_get_by_name(ILI9488_SPI_NAME);
    qcc74x_spi_init(ili9488_spi, &spi_cfg);
