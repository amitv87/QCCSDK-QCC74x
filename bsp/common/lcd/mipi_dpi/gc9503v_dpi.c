...
static struct qcc74x_device_s *gc9503v_gpio;
...
static void gc9503v_soft_spi_init(void)
{
    ...
    /* gpio12 spi cs init */
    gc9503v_gpio = qcc74x_device_get_by_name("gpio");

    qcc74x_gpio_init(gc9503v_gpio, GC9503V_DPI_SPI_CS_PIN, GPIO_OUTPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
    qcc74x_gpio_init(gc9503v_gpio, GC9503V_DPI_SPI_CLK_PIN, GPIO_OUTPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
    qcc74x_gpio_init(gc9503v_gpio, GC9503V_DPI_SPI_DAT_PIN, GPIO_OUTPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
    GC9503V_SPI_CS_HIGH;
