...
os.environ[r'qcc74x_SDK_BASE'] = os.path.abspath(r'../..')
os.environ[r'DOXYGEN_OUTPUT_DIR'] = os.path.abspath(r'_static')

def doxygen_run(qcc74x_sdk_path):
    shutil.rmtree(os.environ[r'DOXYGEN_OUTPUT_DIR'], ignore_errors=True)
    doxygen_conf = os.path.join(qcc74x_sdk_path, r'docs/doxygen/Doxyfile')
...
doxygen_run(os.environ[r'qcc74x_SDK_BASE'])

# -- Project information

project = 'qcc74xSDK'
copyright = '2022, Qualcomm Team'
author = 'Qualcomm Team'
