...
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(lightness_pub, 2 + 3, ROLE_NODE);
...
static qcc74x_ble_mesh_light_lightness_srv_t lightness_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_RSP_BY_APP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_RSP_BY_APP,
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(ctl_pub, 2 + 3, ROLE_NODE);
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(hsl_pub, 2 + 3, ROLE_NODE);
