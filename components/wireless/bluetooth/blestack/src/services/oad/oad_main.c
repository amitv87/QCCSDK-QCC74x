...
#if !defined(CONFIG_QCC74x_MCU_SDK)
#include "hal_boot2.h"
#include "qcc74x_flash.h"
#include "qcc74x_sys.h"
#include "hosal_ota.h"
//#include "qcc74x_undef_common.h"
#include "hal_sys.h"
#else
#include "partition.h"
#include "hal_flash.h"
...
static int oad_hal_boot2_partition_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if (QCC74x_PT_MAGIC_CODE != boot2_partition_table.table.pt_table.magicCode) {
        return -EIO;
    }
