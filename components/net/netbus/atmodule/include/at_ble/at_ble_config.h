...
#define BLE_GATT_CHAR_PROP_READ 0x01
#define BLE_GATT_CHAR_PROP_WRITE_WITHOUT_RESP 0x02
#define BLE_GATT_CHAR_PROP_WRITE 0x04
#define BLE_GATT_CHAR_PROP_NOTIFY 0x08
#define BLE_GATT_CHAR_PROP_INDICATE 0x10
