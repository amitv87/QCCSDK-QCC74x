...
void cam_gpio_init(void)
{
    ...
    /* MCLK GPIO */
    qcc74x_gpio_init(gpio, GPIO_PIN_6, GPIO_FUNC_CLKOUT | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1);
...
int main(void)
{
    ...
    cam_config.output_bufaddr = QCC74x_PSRAM_BASE + 480 * 320 * 4;
