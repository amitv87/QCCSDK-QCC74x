...
bool ATTR_TCM_SECTION region_rwe_test(const qcc74x_flash_secreg_region_info_t *info, void *data)
{
    ...
    switch (test->test) {
        case REGION_ERASE:
            ...
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_opunlock());
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_erase_by_idx(info->index));
            end = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_oplock());
        ...
        case REGION_WRITE:
            ...
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_opunlock());
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_write_by_idx(info->index, 0, test->wbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_oplock());
        ...
        case REGION_WREAD:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read_by_idx(info->index, 0, test->wrbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
        ...
        case REGION_EREAD:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read_by_idx(info->index, 0, test->erbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
...
int ATTR_TCM_SECTION main(void)
{
    ...
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_get_param(&param));
    LOG_I("Test %d ok\r\n", ++count);
    print_param(param);
    ...
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_get_lockbits(&lb));
    LOG_I("lock bit is 0x%02x\r\n", lb);
    LOG_I("Test %d ok\r\n", ++count);
    LOG_I("================================\r\n");

    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_region_foreach(print_region, NULL));
    LOG_I("Test %d ok\r\n", ++count);
    ...
    test.erase_byte = 0;
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_region_foreach(region_rwe_test, (void *)&test));
    ...
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_opunlock());
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_erase(0, test.erase_byte));
    end = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_oplock());
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read(0, test.erbuf, test.eread_byte));
    end = qcc74x_mtimer_get_time_us();
    ...
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_opunlock());
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_write(0, test.wbuf, test.write_byte));
    end = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_oplock());
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read(0, test.wrbuf, test.wread_byte));
    end = qcc74x_mtimer_get_time_us();
